...
output$ui_about <- renderUI({
  ...
  out <- fluidRow(
    column(width = 8, offset = 2, h3(strong("sdcApp"))),
  ...
  if (is.null(inputdata())) {
    ...
    out <- list(out, fluidRow(
      column(width = 8, offset = 2, h4(strong("Getting started"))),
  ...
  out <- list(out, fluidRow(
    column(width = 8, offset = 2, h4(strong("Set storage path"))),
    ...
    column(width = 8, offset = 2, h4(strong("Stop the interface"))),
    ...
    column(width = 8, offset = 2, h4(strong("Restart the interface"))),
  ...
  out <- list(out, fluidRow(
    column(width = 8, offset = 2, h4(strong("Contact and Feedback"))),
