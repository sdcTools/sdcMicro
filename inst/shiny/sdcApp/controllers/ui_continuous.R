...
output$ui_topbotcoding_num <- renderUI({
  ...
  output$ui_topbot_params_num <- renderUI({
    ...
    sel_kind <- radioButtons("sel_topbot_kind_num", choices=c("top","bottom"),
      label=h5("Apply top/bottom coding?", tipify(icon("info-circle"), title=txt_tooltip1, placement="top")), inline=TRUE)
    txt_val <- textInput("num_topbot_val_num", label=h5("Threshold value", tipify(icon("info-circle"), title=txt_tooltip2, placement="top")),
      placeholder="Please enter a number", width="75%")
    txt_replace <- textInput("num_topbot_replacement_num", label=h5("Replacement Value", tipify(icon("info-circle"), title=txt_tooltip3, placement="top")),
      placeholder="Please enter a number", width="75%")
...
output$ui_microaggregation <- renderUI({
  ...
  output$ui_microagg_clusterbased <- renderUI({
    ...
    rb_clustermethod <- radioButtons("rb_microagg_clustermethod",
      label=h5("Clustermethod", tipify(icon("info-circle"), title=txt_clmethod, placement="top")),
    ...
    rb_transf <- radioButtons("rb_microagg_transf",
      label=h5("Transformation", tipify(icon("info-circle"), title=txt_cltransf, placement="top")),
    ...
    sl_nc <- isolate(sliderInput("sl_microagg_nc",
      label=h5("Number of clusters", tipify(icon("info-circle"), title=txt_clnrcl, placement="top")),
  ...
  output$ui_microagg_strata <- renderUI({
    ...
    selectInput("sel_microagg_strata",
      label=h5("Apply microaggregation in groups (stratification)?", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$ui_microagg_use_cluster <- renderUI({
    ...
    radioButtons("rb_microagg_cluster",
      label=h5("Use a cluster-based method?", tipify(icon("info-circle"), title=txt_tooltip, placement="bottom")),
  ...
  output$ui_microagg_method <- renderUI({
    ...
    if (input$rb_microagg_cluster=="No") {
      sel_method <- selectInput("sel_microagg_method",
        label=h5("Select the method", tipify(icon("info-circle"), title=txt, placement="bottom")),
        choices=choices_aggmethods(), selected=input$sel_microagg_method, width="100%")
    } else {
      sel_method <- selectInput("sel_microagg_method",
        label=h5("Select the method", tipify(icon("info-circle"), title=txtClus, placement="bottom")),
        choices=choices_aggmethods(), selected=input$sel_microagg_method, width="100%")
    }
  })
  output$ui_microagg_vars <- renderUI({
    ...
    selectInput("sel_microagg_v", choices=possvars_numericmethods(),
      label=h5("Select variables for microaggregation", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$ui_microagg_agglevel <- renderUI({
    ...
    sliderInput("sl_microagg_aggr",
      label=h5("Aggregation-level", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
      min=1, max=15, step=1, value=3, width="100%")
  })
  output$ui_microagg_aggmeasures <- renderUI({
    ...
    radioButtons("sl_microagg_measure",
      label=h5("Aggregation statistics", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$ui_microagg_trim <- renderUI({
    ...
    sliderInput("sl_microagg_trim",
      label=h5("Trimming-percentage", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$ui_microagg_varsort <- renderUI({
    ...
    sel_varsort <- selectInput("sel_microagg_varsort",
      label=h5("Select variable for sorting", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
...
output$ui_noise <- renderUI({
  ...
  output$ui_noise_method <- renderUI({
    ...
    selectInput("sel_noise_method",
      label=h5("Select the algorithm", tipify(icon("info-circle"), title=txt_tooltip, placement="bottom")),
  ...
  output$ui_noise_vars <- renderUI({
    ...
    selectInput("sel_noise_v", choices=get_numVars_names(),
      label=h5("Select variables", tipify(icon("info-circle"), title=txt_tooltip, placement="bottom")),
...
output$ui_rankswap <- renderUI({
  ...
  output$ui_rankswap_vars <- renderUI({
    ...
    selectInput("sel_rankswap_v",
      choices=possvars_numericmethods(), label=h5("Select variables", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$sl_rankswap_top <- renderUI({
    ...
    sliderInput("sl_rankswap_top",
      label=h5("Percentage of highest values that are grouped together before rank swapping", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$sl_rankswap_bot <- renderUI({
    ...
    sliderInput("sl_rankswap_bot",
      label=h5("Percentage of lowest values that are grouped together before rank swapping", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
      min=0, max=25, step=1, value=0, width="100%")
  ...
  output$sl_rankswap_k0 <- renderUI({
    ...
    sliderInput("sl_rankswap_k0",
      label=h5("Subset-mean preservation factor", tipify(icon("info-circle"), title=txt_tooltip, placement="bottom")),
  ...
  output$sl_rankswap_r0 <- renderUI({
    ...
    sliderInput("sl_rankswap_r0",
      label=h5("Multivariate preservation factor", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
  ...
  output$sl_rankswap_p <- renderUI({
    ...
    sliderInput("sl_rankswap_p",
      label=h5("Rank range as percentage of total sample size.", tipify(icon("info-circle"), title=txt_tooltip, placement="top")),
