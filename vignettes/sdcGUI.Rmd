...
### [tbw] Convert variables to numeric

- `Choose variable`: selection of any current factor variables is possible
- Button `Recode to numeric`: Afterwards it jumps to the [explore variable](#explore_inputvars) page with the first of the recoded variables being selected.
...
### [tbw] Create a stratification variable
- Explain why this is in the GUI. Stratification can be selected in some anonymization methods!

- `Select Variables` one or mor variables from the micro data can be selected

- `desired variable name`: Textinput where new variable name can be specified. by default, the selected variable names are pasted together using `_` as seperator
- Button `Create stratification variable`
...
### [tbw] Anonymize categorical variables
#### [tbw] Recoding
...
### [tbw] Anonymize numerical variables
