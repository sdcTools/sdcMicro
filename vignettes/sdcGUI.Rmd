...
- Suda2 scores can only be computed for scenarios with >= 3 categorical key variables! 
...
- Select a value for sampling fraction for the stratified sampling
- button `Calculate suda2-scores`
Thresholds (DisFraction=0.1)
